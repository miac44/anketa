...
--
-- Host: localhost
-- Generation Time: Mar 24, 2016 at 01:06 PM
...
(1, '95.108.225.213', 'Костромской район', 'Городская больница г. Костромы', 'Март', '2016', 'к врачу-педиатру участковому', 'Да', 'Да', '', 'на прием', '3 часа', '', '', '', '', 'Нет', '', 'другое\r\n', 'Да', 'Да', 'Да', 'Нет', '', 'Нет', 'отсутствие свободных мест ожидания, состояние гардероба, отсутствие питьевой воды', 'Нет', '', '', '', 'не назначалось', 'Нет', 'не назначалось', 'Нет', 'Да', 'Да', 'за счет ОМС, бюджет', 'Да', 'раз в месяц', 'раз в квартал', 'Нет', '', 'Нет', '', ''),
(2, '85.113.208.30', 'Костромской район', 'Окружная больница Костромского округа №1', 'Февраль', '2016', 'к врачу-специалисту (лор, хирург, невролог, офтальмолог, стоматолог, другие)', '', '', '', '', '', 'Да', 'Да', '', 'менее 7 календарных дней', 'Да', 'в регистратуре лично', '', 'Нет', 'Да', 'Нет', 'Нет', '', 'Нет', 'состояние туалета, санитарные условия', 'Нет', '', '', '', 'не назначалось', '', 'не назначалось', '', 'Да', 'Да', 'за счет ОМС, бюджет', 'Нет', 'не обращаюсь', 'не обращаюсь', 'Нет', '', 'Нет', '', ''),
(3, '213.87.151.5', 'Островский район', 'Островская РБ', 'Март', '2016', 'к врачу-специалисту (лор, хирург, невролог, офтальмолог, стоматолог, другие)', '', '', '', '', '', 'Нет', 'Нет', 'Другое', '', 'Да', 'в регистратуре лично', '', 'Нет', 'Да', 'Нет', 'Да', 'Нет', 'Нет', 'отсутствие свободных мест ожидания, состояние гардероба, отсутствие питьевой воды, отсутствие мест для детских колясок', 'Нет', '', '', '', '10 календарных дней', 'Нет', 'не назначалось', 'Да', 'Нет', 'Нет', 'за счет ОМС, бюджет', 'Да', 'раз в год', 'раз в год', 'Нет', '', 'Да', 'я сам (а)', ''),
(4, '85.113.208.68', 'Кологривский район', 'Кологривская РБ', 'Январь', '2016', 'к врачу-терапевту участковому', 'Да', 'Да', '', 'на прием', 'менее 1 часа', '', '', '', '', 'Да', 'в регистратуре лично', '', 'Да', 'Да', 'Да', 'Нет', '', 'Да', '', 'Нет', '', '', '', 'менее 7 календарных дней', 'Да', 'не назначалось', 'Нет', 'Да', 'Да', 'за счет ОМС, бюджет', 'Да', 'раз в год', 'не обращаюсь', 'Нет', '', 'Нет', '', ''),
(5, '46.42.37.86', 'Костромской район', 'Костромской областной госпиталь для ветеранов войн', 'Февраль', '2016', 'к врачу-специалисту (лор, хирург, невролог, офтальмолог, стоматолог, другие)', '', '', '', '', '', 'Да', 'Нет', 'Другое', 'менее 7 календарных дней', 'Нет', '', 'другое\r\n', 'Нет', 'Да', 'Да', 'Нет', '', 'Да', '', 'Да', 'II группа', 'Нет', 'отсутствие пандусов, поручней, отсутствие адаптированных лифтов, отсутствие сменных кресел-колясок, отсутствие информационных бегущих строк,информационных стендов, голосовых сигналов', 'менее 7 календарных дней', 'Да', 'не назначалось', 'Нет', 'Нет', 'Нет', 'за счет ОМС, бюджет', 'Нет', 'не обращаюсь', 'не обращаюсь', 'Нет', '', 'Нет', '', ''),
(6, '109.161.14.249', 'Нейский район', 'Нейская РБ', 'Февраль', '2016', 'другое (диспансеризация, профосмотр, справка, рецепт и т.д.)', '', '', '', '', '', 'Да', 'Да', '', 'менее 7 календарных дней', 'Да', 'в регистратуре лично', '', 'Да', 'Да', 'Да', 'Да', 'Да', 'Да', '', 'Нет', '', '', '', 'менее 7 календарных дней', 'Да', 'не назначалось', '', 'Да', 'Да', 'за счет ОМС, бюджет', 'Да', 'раз в полугодие', 'раз в полугодие', 'Нет', '', 'Нет', '', ''),
(7, '134.19.145.117', 'Шарьинский район', 'Шарьинская окружная больница им. Каверина В.Ф.', 'Март', '2016', 'к врачу-педиатру участковому', 'Да', 'Да', '', 'на прием', 'менее 1 часа', '', '', '', '', 'Да', 'в регистратуре лично', '', 'Да', 'Да', 'Да', 'Нет', '', 'Да', '', 'Нет', '', '', '', 'не назначалось', '', 'не назначалось', '', 'Да', 'Да', 'за счет ОМС, бюджет', 'Да', 'раз в полугодие', 'не обращаюсь', 'Нет', '', 'Да', 'я сам (а)', ''),
(8, '109.161.14.44', 'Буйский район', 'Буйская ГБ', 'Март', '2016', 'к врачу-терапевту участковому', 'Да', 'Да', '', 'на прием', 'менее 1 часа', '', '', '', '', 'Да', 'в регистратуре лично', '', 'Да', 'Да', 'Да', 'Да', 'Да', 'Да', '', 'Нет', '', '', '', 'менее 7 календарных дней', 'Да', 'не назначалось', 'Да', 'Да', 'Да', 'за счет ОМС, бюджет', 'Да', 'раз в полугодие', 'раз в полугодие', 'Нет', '', 'Нет', '', ''),
(9, '134.19.147.216', 'Костромской район', 'Костромская областная клиническая больница', 'Март', '2016', 'к врачу-специалисту (лор, хирург, невролог, офтальмолог, стоматолог, другие)', 'Нет', 'Нет', 'Вам не разъяснили информацию о состоянии\r\nздоровья', 'на прием', 'менее 1 часа', 'Нет', 'Нет', 'Вам не разъяснили информацию о состоянии\r\nздоровья', 'менее 7 календарных дней', 'Нет', 'с использованием сети Интернет', 'не дозвонился', 'Нет', 'Нет', 'Нет', 'Да', 'Нет', 'Нет', 'отсутствие питьевой воды', 'Нет', '', 'Да', '', 'менее 7 календарных дней', 'Да', 'менее 15 календарных дней', 'Да', 'Нет', 'Нет', 'на платной основе', 'Нет', 'раз в год', 'раз в год', 'Нет', 'отрицательный', 'Нет', '', ''),
(10, '46.42.18.139', 'Костромской район', 'Костромская областная клиническая больница', 'Март', '2016', 'к врачу-специалисту (лор, хирург, невролог, офтальмолог, стоматолог, другие)', '', '', '', '', '', 'Да', 'Да', '', 'менее 7 календарных дней', 'Да', 'с использованием сети Интернет', '', 'Да', 'Да', 'Да', 'Нет', '', 'Да', '', 'Нет', '', '', '', 'менее 7 календарных дней', 'Да', 'не назначалось', 'Да', 'Да', 'Да', 'за счет ОМС, бюджет', 'Да', 'раз в год', 'раз в год', 'Нет', '', 'Нет', '', '');
...
(1, '79.175.40.37', 'Мантуровский район', 'Мантуровская ОБ', 'Январь', '2016', 'экстренная', '', '', '', '', '', '', 'за счет ОМС, бюджет', 'Нет', '', '', '', 'Нет', '', 'Нет', '', 'круглосуточного пребывания', 'Да', 'Нет', 'Нет', 'Нет', '', 'Нет', 'Вам не разъяснили информацию о состоянии здоровья', 'Нет', 'медицинской организации требуется ремонт', 'Нет', 'Нет', 'Нет', 'Нет', '', 'Нет', '', ''),
(2, '109.161.20.179', 'Буйский район', 'Буйская ГБ', 'Февраль', '2016', 'плановая', 'меньше 15 календарных дней', 'Да', 'Да', '', 'до 30 мин', 'Да', 'за счет ОМС, бюджет', 'Нет', '', '', '', 'Да', 'Да', 'Да', 'Да', 'круглосуточного пребывания', 'Да', 'Да', 'Нет', 'Нет', '', 'Да', '', 'Да', '', 'Да', 'Да', 'Да', 'Нет', '', 'Нет', '', ''),
(3, '83.220.239.197', 'Костромской район', 'Костромская областная клиническая больница', 'Март', '2016', 'плановая', '30 календарных дней и более\n', 'Нет', 'Нет', 'отсутствие свободных мест ожидания', '90 мин и более', 'Да', 'на платной основе', 'Нет', '', '', '', 'Нет', '', 'Да', 'Нет', 'круглосуточного пребывания', 'Да', 'Да', 'Да', 'Нет', '', 'Да', '', 'Да', 'в медицинской организации старая мебель', 'Да', 'Да', 'Нет', 'Нет', '', 'Да', 'я сам (а)', 'деньги'),
(4, '78.25.121.249', 'Галичский район', 'Галичская ОБ', 'Январь', '2016', 'плановая', 'меньше 15 календарных дней', 'Да', 'Да', '', 'до 30 мин', 'Да', 'за счет ОМС, бюджет', 'Нет', '', '', '', 'Нет', '', 'Да', 'Да', 'дневного стационара', '', '', '', '', '', 'Да', '', 'Да', '', 'Да', 'Да', 'Да', 'Нет', '', 'Нет', '', ''),
(5, '109.161.14.44', 'Буйский район', 'Буйская ГБ', 'Март', '2016', 'плановая', 'меньше 15 календарных дней', 'Да', 'Да', '', 'до 30 мин', 'Да', 'за счет ОМС, бюджет', 'Нет', '', '', '', 'Да', 'Да', 'Да', 'Да', 'дневного стационара', '', '', '', '', '', 'Да', '', 'Да', '', 'Да', 'Да', 'Да', 'Нет', '', 'Нет', '', '');
