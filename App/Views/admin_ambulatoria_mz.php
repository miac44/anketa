...
<div class="container-fluid">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <th rowspan="3" class="text-center">Кол-во (МЗ)</th>
        ...
        <?php foreach ($ambulances as $ambulance) : ?>
            <tr>
                ...
                <td><?php echo $ambulance->ambulatoriamz->getCountByType('mz'); ?></td>
                <td>-</td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_1_2()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_1_3()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_1_4()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_1_5()->points; ?></td>
                <td class="text-center info"><?php echo $points_1=$ambulance->ambulatoriamz->get_1_2()->points+$ambulance->ambulatoriamz->get_1_3()->points+$ambulance->ambulatoriamz->get_1_4()->points+$ambulance->ambulatoriamz->get_1_5()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_2_1()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_2_2()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_2_3()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_2_4()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_2_5()->points; ?></td>
                <td class="text-center info"><?php echo $points_2=$ambulance->ambulatoriamz->get_2_1()->points+$ambulance->ambulatoriamz->get_2_2()->points+$ambulance->ambulatoriamz->get_2_3()->points+$ambulance->ambulatoriamz->get_2_4()->points+$ambulance->ambulatoriamz->get_2_5()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_3_1()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_3_2()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_3_3()->points; ?></td>
                <td class="text-center info"><?php echo $points_3=$ambulance->ambulatoriamz->get_3_1()->points+$ambulance->ambulatoriamz->get_3_2()->points+$ambulance->ambulatoriamz->get_3_3()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_4_1()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_4_2()->points; ?></td>
                <td class="text-center info"><?php echo $points_4=$ambulance->ambulatoriamz->get_4_1()->points+$ambulance->ambulatoriamz->get_4_2()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_5_1()->points; ?></td>
                <td class="text-center"><?php echo $ambulance->ambulatoriamz->get_5_2()->points; ?></td>
                <td class="text-center info"><?php echo $points_5=$ambulance->ambulatoriamz->get_5_1()->points+$ambulance->ambulatoriamz->get_5_2()->points; ?></td>
